        ...
        return (
          <View style={styles.container}>
            ...
            <ScrollView style={{ flex: 1 }}>
              {loading ? <ActivityIndicator size="large" color="#005BB5" style={{ marginTop: 50 }} /> : (activeTab === 'plan' ? renderPlanEditor() : activeTab === 'monitor' ? renderAiMonitor() :  <ProgressAnalyticsScreen patient={patient} />)}
            </ScrollView>
